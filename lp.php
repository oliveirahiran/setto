...
<head>
    ...
    <style type="text/css">
        ...
        * {
        ...
        body {
            font-family: 'Lufga', 'Nunito Sans', Arial, sans-serif;
            color: #1e293b;
            background: #fff;
            overflow-x: hidden;
        }
        ...
        /* ...demais utilitários conforme necessário... */
        ...
        .btn-primary:hover {
            ...
            box-shadow: 0 10px 15px -3px rgba(251, 86, 7, .3);
        }
...
<!-- ...restante do seu HTML permanece igual, apenas troque as classes Tailwind por essas classes locais se necessário... -->
<?php wp_footer(); ?>
</body>
